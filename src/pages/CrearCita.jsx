      ...
      <div className="flex justify-center items-start">
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <button
              className="bg-customC hover:text-customE text-customA font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline flex items-center justify-center"
              type="submit"
            >
              <span className="mr-2">
                <img
