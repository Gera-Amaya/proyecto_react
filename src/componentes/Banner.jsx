    ...
    return(
        <section className="bg-customD text-customA">
            <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
                ...
                <h1
                    className="bg-gradient-to-r from-customB via-customA to-customB bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"
                >
                    Tus citas sin estres.

                    <span className="sm:block"> Incrementa tu alcance. </span>
                </h1>

                <p className="mx-auto mt-4 max-w-xl sm:text-xl/relaxed">
                    Podemos ayudarte a solucionar tus problemas al agendar citas.
                </p>
