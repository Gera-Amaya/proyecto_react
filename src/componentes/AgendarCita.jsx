...
return (
    ...
    <form className="bg-slate-400 shadow-md rounded px-6 pt-6 pb-8 mb-2">
        ...
        <div className="flex items-center justify-center">
            <Link to="/cita" className="flex items-center hover:bg-slate-400 hover:text-slate-300 transition-color duration-600 text-black font-bold rounded focus:outline-none focus:shadow-outline transition-all">
